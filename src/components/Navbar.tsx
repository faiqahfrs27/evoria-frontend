...
function Navbar() {
  ...
  const goToSearchPage = (keyword: string) => {
    ...
    if (trimmedKeyword) {
      navigate(`/events?search=${encodeURIComponent(trimmedKeyword)}&page=1`);
          ...
          <div className="hidden items-center gap-3 sm:flex">
            <div className="relative">
              ...
              <input
                ...
                className="h-10 w-44 rounded-sm border border-[rgba(212,169,74,0.32)] bg-[#14141A]/80 pl-9 pr-3 text-sm text-[#F9F3E8] outline-none transition placeholder:text-[#6F6F7D] focus:border-[#D4A94A]/70 lg:w-56"
              />
            </div>
          ...
          <div className="space-y-4 border-t border-[rgba(212,169,74,0.16)] bg-[#0D0D0F] py-5 sm:hidden">
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) => setSearch(e.target.value)}
                onKeyDown={handleKeyDown}
                className="w-full rounded-sm border border-[rgba(212,169,74,0.32)] bg-[#14141A] py-3 pl-9 pr-3 text-sm text-[#F9F3E8] outline-none placeholder:text-[#6F6F7D] focus:border-[#D4A94A]/70"
              />
            </div>
